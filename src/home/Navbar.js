    ...
    <div className='links'>
      <ul className='links-list'>
        ...
        <Link to="/Men" id='nav-links' >
          <li className={navbar ? 'mx-3 act' : 'mx-3'}>Men</li>
        </Link>

        <Link to="/Women" id='nav-links' >
          <li className={navbar ? 'mx-3 act' : 'mx-3'}>Women</li>
        </Link>

        <Link to="/Kids" id='nav-links' >
          <li className={navbar ? 'mx-3 act' : 'mx-3'}>Kids</li>
        </Link>

        <Link to="/NewArrivals" id='nav-links' >
          <li  className={navbar ? 'mx-3 act' : 'mx-3'}>New Arrivals</li>
        </Link>

        <Link to="/Sale" id='nav-links' >
          <li className={navbar ? 'mx-3 act' : 'mx-3'}>Sale</li>
        </Link>
      </ul>
    </div>
